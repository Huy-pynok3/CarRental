...
const Navbar = () => {
    ...
    return (
        ...
        >
            ...
            right-0 flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-8 max-sm:p-4 transiton-all duration-300
            z-50 ${location.pathname === "/" ? "bg-light" : "bg-white"} ${
            ...
            >
                ...
                <div
                    className="hidden lg:flex items-center text-sm gap-2 border border-borderColor px-3
