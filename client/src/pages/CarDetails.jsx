            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
                ...
                <form onSubmit={handleSubmit} className="shadow-lg h-max sticky top-18 rounded-xl p-6 space-y-6 text-gray-500">
                    ...
                    <div className='flex flex-col gap-2'>
                        ...
                        <input type="date" id='pickup-date' min={new Date().toDateString().split('T')[0]} className='border border-borderColor px-3 py-2 rounded-lg' required/>
                    </div>
                    ...
                    <button class="w-full bg-primary hover:bg-primary-dull transition-all py-3 font-medium text-white rounded-xl cursor-pointer">
                        Book Now
                    </button>      
